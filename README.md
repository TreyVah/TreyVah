...
AI/ML engineering student building **credit risk and fintech systems** for African lending institutions.

- 🔭 Currently working on **RiskNova** — a banking-grade credit scoring platform (XGBoost, AUC 0.94+, SHAP explainability)
- 🌱 Also building **StreakFit** — a workout streak & focus platform (FastAPI + PostgreSQL + JWT auth)
- 🎓 BSc Artificial Intelligence & Machine Learning @ ISBAT University
- 📫 **trevormesach23@gmail.com** · Portfolio: [treyvah.github.io](https://treyvah.github.io)
